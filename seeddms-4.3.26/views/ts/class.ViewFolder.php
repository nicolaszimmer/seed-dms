...
?>
<div class='area-container'><div id="dragandrophandler" data-target="<?php echo $folder->getID(); ?>" data-formtoken="<?php echo createFormKey('adddocument'); ?>"><i class='icon-upload' style='padding-left:5px'></i><?php printMLText('drop_files_here'); ?></div></div>
<?php
			echo "</div>";
			echo "</div>";
		}
